...
try:
    prox= requests.get('https://raw.githubusercontent/mafiat2/M16/blob/main/proxy.txt').text
...
usr=[]
try:
    xd=requests.get('https://raw.githubusercontent/mafiat2/M16/blob/main/proxies.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
