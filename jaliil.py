...
for agent in range(10000):
        ...
        ugen.append(fullagnt)      
try:
    prox= requests.get('https://raw.githubusercontent.com/jalilha1/jalil/main/proxies.txt').text
...
android_models=[]
try:
    xx= requests.get('https://raw.githubusercontent.com/jalilha1/jalil/main/strings.txt').text.splitlines()
    for line in xx:
...
usr=[]
try:
    xd= requests.get('https://raw.githubusercontent.com/jalilha1/jalil/main/ua.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
`Y888P                                                             
\033[1;33m========================================================
 \033[1;32mFACEBOOK  \033[1;91m: \033[1;36mH. M. JALIL\033[1;37m
 \033[1;32mTELEGRAM  \033[1;91m: \033[1;36mITZJALIL0\033[1;37m
 \033[1;32mWHATSAPP  \033[1;91m: \033[1;36m213676980481\033[1;37m
 \033[1;32mVERSION     \033[1;91m: \033[1;36m1.4\033[1;37m
 \033[1;32mTOOL        \033[1;91m: \033[1;36mPAID\033[1;37m
\033[1;33m========================================================\033[1;33m
""")
def linex():
