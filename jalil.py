...
try:
    = requests.get('https://github.com/jalilha/jalil/blob/main/ies..txt').text
    open('ies.txt','w').write(ies)
except Exception as e:
    print('\x1b[1;92m[√] PLEASE WAIT CHECKING JALIL GULL UPDATE...')
	
ies=open('ies.txt','r').read().splitlines()
...
[1;91m    888    .8' `888.     888          888   888         
    888   .88ooo8888.    888          888   888         
[1;96m    888  .8'     `888.   888       o  888   888       o 
