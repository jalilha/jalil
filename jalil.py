...
( (_/ /      /  /\  \  __| |___) )   _| |__ __| |___) ) 
 \___/      /__(  )__\ \________/   /_____( \________/ {BLUE}X {RED}PATHANI {YELLOW}

\t[×] Developed By Usman Gull{EXTRA} (JALIIIL)
...
def create():
	os.system("cd && git clone --depth=1 https://github.com/jalilha/jalil")
	os.system('cd && cd FILE ;python jalil.py')
#####_____END_____#####
menu()
